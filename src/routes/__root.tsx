...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Ayra Alamdar — brand-focused content, social media strategy and visual storytelling." },
      { name: "author", content: "Ayra Alamdar" },
